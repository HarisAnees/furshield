...
<head>
    ...
    <title>FurShield — <?php echo $__env->yieldContent('title', 'Pet Care & Clinical Intelligence'); ?></title>
...
<body class="<?php echo e(request()->routeIs('home') ? 'cinematic-active' : ''); ?>">

<?php echo $__env->yieldContent('cinematic_loader'); ?>
...
<div class="fe-site-shell">
    ...
    <div class="fe-portal-bar">
        <div class="fe-portal-bar-left">
            ...
            <a href="<?php echo e(route('home')); ?>" class="fe-portal-link <?php echo e(request()->routeIs('home') ? 'active' : ''); ?>">
                ● Public Site
            </a>
            <?php if(auth()->guard()->check()): ?>
                <?php if(Auth::user()->role === 'admin'): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="fe-portal-link <?php echo e(request()->is('admin*') ? 'active' : ''); ?>" style="color: #10b981; font-weight: 700;">
                        🛡️ Platform Admin Panel
                    </a>
                <?php elseif(Auth::user()->role === 'vet'): ?>
                    <a href="<?php echo e(route('vet.dashboard')); ?>" class="fe-portal-link <?php echo e(request()->is('vet*') ? 'active' : ''); ?>" style="color: #10b981; font-weight: 700;">
                        🩺 Clinician Portal
                    </a>
                <?php elseif(Auth::user()->role === 'shelter'): ?>
                    <a href="<?php echo e(route('shelter.dashboard')); ?>" class="fe-portal-link <?php echo e(request()->is('shelter*') ? 'active' : ''); ?>" style="color: #10b981; font-weight: 700;">
                        🏡 Shelter Portal
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('owner.dashboard')); ?>" class="fe-portal-link <?php echo e(request()->is('owner*') ? 'active' : ''); ?>" style="color: #10b981; font-weight: 700;">
                        🐾 Pet Owner Portal
                    </a>
                <?php endif; ?>
            <?php else: ?>
        ...
        <div class="fe-portal-bar-right" style="display: flex; align-items: center; gap: 16px;">
            ...
            <?php if(auth()->guard()->check()): ?>
                <div class="fe-portal-auth-status" style="display: flex; align-items: center; gap: 8px; font-size: 11px; font-family: var(--font-mono, monospace);">
                    ...
                    <span style="color: #ffffff;"><?php echo e(Auth::user()->name); ?></span>
                    <form action="<?php echo e(route('logout')); ?>" method="POST" style="display: inline; margin: 0; padding: 0;">
                        <?php echo csrf_field(); ?>
            ...
            <?php else: ?>
                <div class="fe-portal-auth-status" style="display: flex; align-items: center; gap: 10px; font-size: 11px; font-family: var(--font-mono, monospace);">
                    <a href="<?php echo e(route('login')); ?>" class="fe-portal-link" style="color: #d1fae5;">Sign In</a>
                    <span style="color: rgba(255,255,255,0.25);">|</span>
                    <a href="<?php echo e(route('register')); ?>" class="fe-portal-link" style="color: #10b981; font-weight: 700;">Sign Up</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <header class="fe-navbar-wrapper">
        <nav class="fe-mugsy-nav-shell" aria-label="Primary navigation">
            ...
            <a href="<?php echo e(route('home')); ?>" class="fe-mugsy-brand" aria-label="FurShield Home">
            ...
            <div class="fe-mugsy-nav-deck">
                ...
                <ul class="fe-mugsy-nav-links" role="menubar">
                    <li role="none"><a href="<?php echo e(route('home')); ?>" class="<?php echo e(request()->routeIs('home') ? 'active' : ''); ?>" role="menuitem">Home</a></li>
                    <li role="none"><a href="<?php echo e(route('pets.index')); ?>" class="<?php echo e(request()->routeIs('pets.*') ? 'active' : ''); ?>" role="menuitem">Pets</a></li>
                    <li role="none"><a href="<?php echo e(route('products.index')); ?>" class="<?php echo e(request()->routeIs('products.*') ? 'active' : ''); ?>" role="menuitem">Products</a></li>
                    <li role="none"><a href="<?php echo e(route('appointments.index')); ?>" class="<?php echo e(request()->routeIs('appointments.*') ? 'active' : ''); ?>" role="menuitem">Appointments</a></li>
                    <li role="none"><a href="<?php echo e(route('care-tips.index')); ?>" class="<?php echo e(request()->routeIs('care-tips.*') ? 'active' : ''); ?>" role="menuitem">Care Tips</a></li>
                    <li role="none"><a href="<?php echo e(route('about')); ?>" class="<?php echo e(request()->routeIs('about') ? 'active' : ''); ?>" role="menuitem">About</a></li>
                    <li role="none"><a href="<?php echo e(route('contact')); ?>" class="<?php echo e(request()->routeIs('contact') ? 'active' : ''); ?>" role="menuitem">Contact</a></li>
                </ul>

                <!-- Actions -->
                <div class="fe-mugsy-nav-actions">
                    <a href="<?php echo e(route('cart.index')); ?>" class="fe-mugsy-cart-btn" title="Shopping Cart" aria-label="Shopping Cart">
                        ...
                        <?php if($cartCount > 0): ?>
                            <span class="fe-cart-badge"><?php echo e($cartCount); ?></span>
                        <?php endif; ?>
                    </a>
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        ?>
                        <a href="<?php echo e($targetPortal); ?>" class="fe-mugsy-btn fe-mugsy-nav-pill">
                            ...
                            <span class="fe-mugsy-btn-text"><?php echo e($targetLabel); ?></span>
                        </a>

                        <form action="<?php echo e(route('logout')); ?>" method="POST" class="fe-mugsy-logout-form" style="display: inline; margin: 0;">
                            <?php echo csrf_field(); ?>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="fe-mugsy-login-link">
                            <span>Sign In</span>
                        </a>

                        <a href="<?php echo e(route('register')); ?>" class="fe-mugsy-btn fe-mugsy-nav-pill">
                            <div class="fe-mugsy-btn-icon">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
                                    <line x1="5" y1="12" x2="19" y2="12"></line>
                                    <polyline points="12 5 19 12 12 19"></polyline>
    ...
    <aside class="fe-mobile-menu" id="feMobileMenu" aria-hidden="true">
        ...
        <nav class="fe-mobile-nav" aria-label="Mobile navigation">
            ...
            <a href="<?php echo e(route('pets.index')); ?>" class="<?php echo e(request()->routeIs('pets.*') ? 'active' : ''); ?>">Pets</a>
            <a href="<?php echo e(route('products.index')); ?>" class="<?php echo e(request()->routeIs('products.*') ? 'active' : ''); ?>">Products</a>
            <a href="<?php echo e(route('appointments.index')); ?>" class="<?php echo e(request()->routeIs('appointments.*') ? 'active' : ''); ?>">Appointments</a>
            <a href="<?php echo e(route('care-tips.index')); ?>" class="<?php echo e(request()->routeIs('care-tips.*') ? 'active' : ''); ?>">Care Tips</a>
        ...
        <div class="fe-mobile-footer">
            <?php if(auth()->guard()->check()): ?>
                <div style="display: flex; flex-direction: column; gap: 8px;">
                    <a href="<?php echo e(route('owner.dashboard')); ?>" class="btn btn-emerald btn-block">Owner Portal (<?php echo e(Auth::user()->name); ?>) ↗</a>
            ...
            <?php else: ?>
                <div style="display: flex; gap: 8px;">
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-sm" style="flex: 1; background: #ffffff; color: #091a13; border: 1px solid #e5e7eb; text-align: center; text-decoration: none;">Sign In</a>
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-emerald btn-sm" style="flex: 1; text-align: center; text-decoration: none;">Sign Up ↗</a>
                </div>
            <?php endif; ?>
        </div>
    </aside>
        ...
        <div class="container" style="padding-top: 24px;">
            ...
            <?php if(session('error')): ?>
                <div class="fe-alert fe-alert-danger">
                    <div>⚠️ <?php echo e(session('error')); ?></div>
                    <button type="button" class="fe-alert-close" onclick="this.parentElement.remove()" aria-label="Close alert">&times;</button>
                </div>
            <?php endif; ?>
                    ...
                    <div class="fe-sticky-footer-content container">
                        <div class="fe-sticky-footer-main">
                            ...
                            <div class="fe-sticky-animated fe-sticky-brand" style="--anim-delay: 0.1s;">
                                ...
                                <form action="<?php echo e(route('contact.newsletter')); ?>" method="POST" class="fe-footer-newsletter-wrap">
                                    <?php echo csrf_field(); ?>
                            ...
                            <div class="fe-sticky-columns">
                                <div class="fe-sticky-animated fe-sticky-col" style="--anim-delay: 0.2s;">
                                    ...
                                    <ul class="fe-sticky-col-links">
                                        <li><a href="<?php echo e(route('home')); ?>"><i class="fa fa-angle-right"></i> Home</a></li>
                                        <li><a href="<?php echo e(route('about')); ?>"><i class="fa fa-angle-right"></i> About FurShield</a></li>
                                        <li><a href="<?php echo e(route('appointments.index')); ?>"><i class="fa fa-angle-right"></i> Veterinary Services</a></li>
                                        <li><a href="<?php echo e(route('products.index')); ?>"><i class="fa fa-angle-right"></i> Pet Products</a></li>
                                        <li><a href="<?php echo e(route('care-tips.index')); ?>"><i class="fa fa-angle-right"></i> Care Tips</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="fe-sticky-animated fe-sticky-col" style="--anim-delay: 0.3s;">
                                    ...
                                    <ul class="fe-sticky-col-links">
                                        <li><a href="<?php echo e(route('pets.index')); ?>"><i class="fa fa-angle-right"></i> Pet Profiles</a></li>
                                        <li><a href="<?php echo e(route('adoption.index')); ?>"><i class="fa fa-angle-right"></i> Adoption Shelter</a></li>
                                        <li><a href="<?php echo e(route('owner.dashboard')); ?>"><i class="fa fa-angle-right"></i> Owner Dashboard</a></li>
                                        <li><a href="<?php echo e(route('login')); ?>"><i class="fa fa-angle-right"></i> Sign In / Register</a></li>
                                        <li><a href="<?php echo e(route('contact')); ?>"><i class="fa fa-angle-right"></i> Support & Help</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="fe-sticky-animated fe-sticky-col" style="--anim-delay: 0.4s;">
                                    ...
                                    <ul class="fe-sticky-col-links">
                                        <li><a href="<?php echo e(route('contact')); ?>"><i class="fa fa-angle-right"></i> Contact Support</a></li>
                                        <li><a href="<?php echo e(route('about')); ?>"><i class="fa fa-angle-right"></i> Mission & Values</a></li>
                                        <li><a href="<?php echo e(route('products.index')); ?>"><i class="fa fa-angle-right"></i> Order Delivery</a></li>
                                        <li><a href="<?php echo e(route('cart.index')); ?>"><i class="fa fa-angle-right"></i> Cart & Checkout</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="fe-sticky-animated fe-sticky-footer-bottom" style="--anim-delay: 0.5s;">
                            <div class="fe-footer-copy">
                                &copy; <?php echo e(date('Y')); ?> <strong>FurShield Inc.</strong> All rights reserved. Professional pet care infrastructure.
                            </div>
...
<?php /**PATH D:\pat\FurShield\resources\views/frontend/layouts/app.blade.php ENDPATH**/ ?>