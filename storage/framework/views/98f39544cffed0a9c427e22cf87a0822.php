<?php $__env->startSection('title', 'Adopt a Pet, Change a Life — FurShield'); ?>
...
<div class="container section">
    ...
    <div id="adoptables" class="reveal delay-1">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(360px, 1fr)); gap: 28px;">
            ...
            <?php $__currentLoopData = $samplePets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $sample): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="card adoption-split-card">
                    <div class="card-text">
                        <div class="portada" style="background-image: url('<?php echo e($sample['img']); ?>');">
                            <span class="portada-badge">Available</span>
                        </div>

                        <div class="title-total">
                            <div>
                                <div class="title"><?php echo e($sample['sub']); ?></div>
                                <h2><?php echo e($sample['name']); ?></h2>
                                <div class="desc">
                                    <?php echo e($sample['traits']); ?> • Fully vaccinated, socialized and ready for loving home placement.
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="actions">
                                    ...
                                    <button type="button" class="adopt-icon-btn" onclick="openAdoptModal(<?php echo e($listingId); ?>, '<?php echo e($sample['name']); ?>')" title="Adopt <?php echo e($sample['name']); ?>" aria-label="Adopt Companion"><i class="fas fa-paw"></i></button>
                                </div>

                                <button type="button" 
                                        onclick="openAdoptModal(<?php echo e($listingId); ?>, '<?php echo e($sample['name']); ?>')" 
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pat\FurShield\resources\views/frontend/adoption.blade.php ENDPATH**/ ?>