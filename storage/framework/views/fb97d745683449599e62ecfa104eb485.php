...
<head>
    ...
    <title>FurShield — <?php echo $__env->yieldContent('title', 'Pet Owner Dashboard'); ?></title>
...
<div class="owner-shell">
    ...
    <div class="top-nav-switcher">
        <div class="switcher-pill">
            ...
            <a href="<?php echo e(route('owner.dashboard')); ?>" class="switcher-btn active">
                <span class="dot-status"></span> Pet Owner Dashboard
            </a>
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="switcher-btn">
                Admin Dashboard
            </a>
        </div>
    </div>
        ...
        <aside class="owner-sidebar" id="sidebar">
            <div>
                <div class="sidebar-top">
                    <a class="brand-lockup" href="<?php echo e(route('owner.dashboard')); ?>">
                ...
                <nav class="owner-nav-list" aria-label="Owner navigation">
                    <a class="owner-nav-item <?php echo e(request()->routeIs('owner.dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('owner.dashboard')); ?>">
                        <span class="nav-icon">
                    ...
                    <a class="owner-nav-item <?php echo e(request()->routeIs('owner.pets*') ? 'active' : ''); ?>" href="<?php echo e(route('owner.pets')); ?>">
                        <span class="nav-icon">
                    ...
                    <a class="owner-nav-item <?php echo e(request()->routeIs('owner.appointments*') ? 'active' : ''); ?>" href="<?php echo e(route('owner.appointments')); ?>">
                        <span class="nav-icon">
                    ...
                    <a class="owner-nav-item <?php echo e(request()->routeIs('owner.health-records*') ? 'active' : ''); ?>" href="<?php echo e(route('owner.health-records')); ?>">
                        <span class="nav-icon">
                            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line></svg>
                        </span>
                        <span>Health Records</span>
                    </a>
                    <a class="owner-nav-item <?php echo e(request()->routeIs('owner.products*') ? 'active' : ''); ?>" href="<?php echo e(route('owner.products')); ?>">
                        <span class="nav-icon">
                    ...
                    <a class="owner-nav-item <?php echo e(request()->routeIs('owner.care-tips*') ? 'active' : ''); ?>" href="<?php echo e(route('owner.care-tips')); ?>">
                        <span class="nav-icon">
                    ...
                    <a class="owner-nav-item <?php echo e(request()->routeIs('owner.notifications*') ? 'active' : ''); ?>" href="<?php echo e(route('owner.notifications')); ?>">
                        <span class="nav-icon">
                    ...
                    <a class="owner-nav-item <?php echo e(request()->routeIs('owner.profile*') ? 'active' : ''); ?>" href="<?php echo e(route('owner.profile')); ?>">
                        <span class="nav-icon">
        ...
        <div class="owner-main-area">
            ...
            <header class="owner-topbar">
                ...
                <div class="header-right-actions">
                    <a href="<?php echo e(route('owner.notifications')); ?>" class="action-icon-btn" title="Notifications" aria-label="Notifications">
                    ...
                    <a href="<?php echo e(route('owner.profile')); ?>" class="user-profile-header">
                        <img src="/images/sarah-avatar.jpg" alt="Sarah Johnson" class="avatar-circle">
                        <div class="user-header-text">
                            <strong><?php echo e(auth()->user()->name ?? 'Sarah Johnson'); ?></strong>
                            <small><?php echo e(ucfirst(auth()->user()->role ?? 'Pet Owner')); ?></small>
                        </div>
                    </a>
                </div>
            </header>
...
<?php /**PATH D:\pat\FurShield\resources\views/owner/layouts/app.blade.php ENDPATH**/ ?>