...
<body>
    ...
    <div class="auth-top-bar">
        ...
        <a href="<?php echo e(route('home')); ?>" class="auth-top-brand">
    ...
    ?>
    <div class="auth-container <?php echo e($isSignUpMode ? 'sign-up-mode' : ''); ?>" id="authContainer">
        <div class="forms-container">
            <div class="signin-signup">

                <!-- 1. SIGN IN FORM -->
                <form action="<?php echo e(route('login.submit')); ?>" method="POST" class="sign-in-form" id="signInForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <?php if($errors->any() && old('_form', 'signin') === 'signin'): ?>
                    ...
                    <div class="input-field two-col">
                        ...
                        <input type="email" name="email" id="loginEmail" value="<?php echo e(old('_form') === 'signin' ? old('email') : ''); ?>" placeholder="Email Address" required autocomplete="email">
                    </div>
                ...
                <!-- 2. SIGN UP FORM -->
                <form action="<?php echo e(route('register.submit')); ?>" method="POST" class="sign-up-form" id="signUpForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <?php if($errors->any() && old('_form') === 'signup'): ?>
                        <div class="auth-errors">
                            <i class="fas fa-exclamation-circle"></i>
                            <div>
                                <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="input-field two-col">
                        ...
                        <input type="text" name="name" value="<?php echo e(old('_form') === 'signup' ? old('name') : ''); ?>" placeholder="Full Name" required autocomplete="name">
                    </div>

                    <!-- Email Field -->
                    <div class="input-field two-col">
                        <i class="fas fa-envelope field-icon"></i>
                        <input type="email" name="email" value="<?php echo e(old('_form') === 'signup' ? old('email') : ''); ?>" placeholder="Email Address" required autocomplete="email">
                    </div>
                    ...
                    <div class="role-selector-wrap">
                        ...
                        <div class="role-pills">
                            <label class="role-pill-label">
                                <input type="radio" name="role" value="owner" <?php echo e(old('role', 'owner') === 'owner' ? 'checked' : ''); ?>>
                                <span>🐾 Pet Owner</span>
                            </label>
                            <label class="role-pill-label">
                                <input type="radio" name="role" value="vet" <?php echo e(old('role') === 'vet' ? 'checked' : ''); ?>>
                                <span>🩺 Clinician</span>
                            </label>
                            <label class="role-pill-label">
                                <input type="radio" name="role" value="shelter" <?php echo e(old('role') === 'shelter' ? 'checked' : ''); ?>>
                                <span>🏠 Shelter</span>
                            </label>
                        </div>
                    </div>
    ...
    <script>
        ...
        if (signUpBtn && authContainer) {
            signUpBtn.addEventListener('click', () => {
                ...
                if (window.history.pushState) {
                    window.history.pushState({ mode: 'signup' }, '', '<?php echo e(route('register')); ?>');
                }
            });
        }
        ...
        if (signInBtn && authContainer) {
            signInBtn.addEventListener('click', () => {
                ...
                if (window.history.pushState) {
                    window.history.pushState({ mode: 'signin' }, '', '<?php echo e(route('login')); ?>');
                }
            });
        }
...
<?php /**PATH D:\pat\FurShield\resources\views/auth/auth_switch.blade.php ENDPATH**/ ?>