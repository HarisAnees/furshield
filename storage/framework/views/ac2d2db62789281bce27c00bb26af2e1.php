<?php $__env->startSection('title', 'Book a Veterinary Appointment — FurShield'); ?>
...
<div class="container section">
    ...
    <div class="fe-hero-shell reveal" style="margin-bottom: 72px;">
        <div class="fe-hero-content">
            ...
            <!-- Working Search Form -->
            <form action="<?php echo e(route('appointments.index')); ?>" method="GET" style="display: flex; gap: 8px; max-width: 480px; margin-top: 8px;">
            ...
            <div style="margin-top: 14px; display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
                ...
                <a href="<?php echo e(route('appointments.index', ['condition' => 'General'])); ?>" style="font-size: 11.5px; padding: 4px 10px; border-radius: 9999px; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.18); color: #ffffff; text-decoration: none;">General Practice</a>
                <a href="<?php echo e(route('appointments.index', ['condition' => 'Feline'])); ?>" style="font-size: 11.5px; padding: 4px 10px; border-radius: 9999px; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.18); color: #ffffff; text-decoration: none;">Feline Medicine</a>
                <a href="<?php echo e(route('appointments.index', ['condition' => 'Diagnostics'])); ?>" style="font-size: 11.5px; padding: 4px 10px; border-radius: 9999px; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.18); color: #ffffff; text-decoration: none;">Internal Diagnostics</a>
                <a href="<?php echo e(route('appointments.index', ['condition' => 'Canine'])); ?>" style="font-size: 11.5px; padding: 4px 10px; border-radius: 9999px; background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.18); color: #ffffff; text-decoration: none;">Canine Wellness</a>
                <?php if(request('search') || request('condition') || request('location')): ?>
                    <a href="<?php echo e(route('appointments.index')); ?>" style="font-size: 11.5px; padding: 4px 10px; border-radius: 9999px; background: rgba(239,68,68,0.2); border: 1px solid rgba(239,68,68,0.4); color: #fca5a5; text-decoration: none;">✕ Clear</a>
                <?php endif; ?>
            </div>
        </div>
    ...
    <div class="reveal delay-1">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 28px;">
            ...
            <?php $__currentLoopData = $defaultDoctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="turbo-card-wrap">
                    <div class="turbo-card">
                        ...
                        <img src="<?php echo e($doc['img']); ?>" alt="<?php echo e($doc['name']); ?>" class="turbo-card-bg">

                        <!-- Status Pill -->
                        <div class="turbo-card-status">
                            <div class="turbo-card-status-dot online"></div>
                            <div class="turbo-card-status-text"><?php echo e($doc['status']); ?></div>
                        </div>

                        <!-- Fee Badge -->
                        <div class="turbo-card-handle" title="Consultation Fee">
                            <span class="turbo-handle-fee">$<?php echo e($doc['fee']); ?>/visit</span>
                        </div>
                        ...
                        <div class="turbo-card-content">
                            ...
                            <div class="turbo-card-name-wrap">
                                <div class="turbo-card-name"><?php echo e($doc['name']); ?></div>
                            ...
                            <div class="turbo-card-tags">
                                <div class="turbo-card-tag">
                                    <div class="turbo-card-rating-text"><?php echo e($doc['rating']); ?></div>
                                ...
                                <div class="turbo-card-tag">
                                    ...
                                    <div class="turbo-card-rating-text"><?php echo e($doc['consults']); ?></div>
                                </div>
                                <div class="turbo-card-tag">
                                    <span><?php echo e($doc['spec']); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="turbo-card-button" 
                                 role="button"
                                 tabindex="0"
                                 onclick="openBookModal(<?php echo e($vetId); ?>, '<?php echo e(addslashes($doc['name'])); ?>', '<?php echo e(addslashes($doc['spec'])); ?>', <?php echo e($doc['fee']); ?>)">
...
<div id="bookingModal" style="display: none; position: fixed; inset: 0; z-index: 9999; background: rgba(13, 15, 17, 0.65); backdrop-filter: blur(4px); align-items: center; justify-content: center; padding: 20px;">
    <div class="card" style="max-width: 520px; width: 100%; max-height: 90vh; overflow-y: auto; box-shadow: var(--shadow-lg); background: var(--white); border-radius: var(--radius-lg);">
        ...
        <form action="<?php echo e(route('appointments.book')); ?>" method="POST" style="padding: 24px;">
            <?php echo csrf_field(); ?>
                ...
                <?php if($pets->count() > 0): ?>
                    <select name="pet_id" required class="form-control">
                        <?php $__currentLoopData = $pets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($pet->id); ?>"><?php echo e($pet->name); ?> (<?php echo e(ucfirst($pet->species)); ?>)</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                <?php else: ?>
                    <div style="background: var(--warning-soft); padding: 12px; border-radius: var(--radius-sm); font-size: 0.88rem; color: #92400e; border: 1px solid #fde68a;">
                        No registered pets found. <a href="<?php echo e(route('pets.index')); ?>" style="color: var(--emerald); font-weight: 700; text-decoration: underline;">Add your pet profile first.</a>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="datetime-local" name="starts_at" required 
                       value="<?php echo e(date('Y-m-d\TH:i', strtotime('+1 day 10:00'))); ?>" 
                       class="form-control">
            </div>
            ...
            <div style="display: flex; justify-content: flex-end; gap: 12px; margin-top: 24px;">
                ...
                <button type="submit" class="btn btn-primary btn-sm" <?php echo e($pets->count() == 0 ? 'disabled' : ''); ?>>
                    Confirm Booking
                </button>
            </div>
        </form>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pat\FurShield\resources\views/frontend/appointments.blade.php ENDPATH**/ ?>