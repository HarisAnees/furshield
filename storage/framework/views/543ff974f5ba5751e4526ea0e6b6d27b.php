<?php $__env->startSection('title', 'Registered Pet Profiles — FurShield'); ?>
...
<div class="container section">
    ...
    <div class="pet-directory-grid reveal delay-1" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 28px; margin-bottom: 64px; align-items: start;">
        <?php $__empty_1 = true; $__currentLoopData = $pets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
            ...
            <div class="pet-fold-card">
                <header>
                    <div class="controls">
                        <div class="controls__back">
                            <span class="pet-id-pill">ID: FUR-<?php echo e(1000 + $pet->id); ?></span>
                        </div>
                    ...
                    <figure>
                        <img src="<?php echo e($img); ?>" alt="<?php echo e($pet->name); ?>">
                    </figure>
                    ...
                    <h2><?php echo e($pet->breed ?? ucfirst($pet->species)); ?></h2>
                    <p class="pet-dob"><?php echo e($dobFormatted); ?></p>
                    <p class="pronouns">
                        <span><?php echo e(strtoupper($pet->sex ?? 'Companion')); ?></span> &bull; 
                        <span><?php echo e(ucfirst($pet->species)); ?></span>
                    </p>
                </header>
                ...
                <main>
                    <blockquote>
                        <p>
                            <?php echo e($pet->notes ?? 'Documented companion profile with verified vaccination status and recorded veterinary visits.'); ?>
                    ...
                    <div class="looking-for">
                        ...
                        <div class="looking-for__description">
                            <div><strong>Chip:</strong> <?php echo e($pet->microchip_number ?? 'FUR-CHIP-'.(1000 + $pet->id)); ?></div>
                            <div><strong>Weight:</strong> <?php echo e($pet->weight_kg ? $pet->weight_kg . ' kg' : 'Standard'); ?></div>
                        </div>
                    </div>
                </main>
                ...
                <footer>
                    <div class="social">
                        <div class="social__icon">
                            <a href="<?php echo e(route('pets.show', $pet)); ?>" title="Clinical Records"><i class="fas fa-file-medical"></i></a>
                        </div>
                        <div class="social__icon">
                            <a href="<?php echo e(route('appointments.index')); ?>" title="Book Clinician"><i class="fas fa-calendar-plus"></i></a>
                        </div>
                        <div class="social__icon">
                            <a href="<?php echo e(route('care-tips.index')); ?>" title="Care Tips"><i class="fas fa-shield-heart"></i></a>
                        </div>
                        <div class="social__icon">
                            <a href="<?php echo e(route('pets.show', $pet)); ?>" title="Pet Profile"><i class="fas fa-paw"></i></a>
                        </div>
                    </div>

                    <a href="<?php echo e(route('pets.show', $pet)); ?>" class="btn-view-profile">
    ...
    <div class="card card-padded reveal delay-2">
        ...
        <div style="display: flex; flex-direction: column; gap: 12px;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; padding: 16px 20px; background: var(--paper); border: 1px solid var(--border); border-radius: var(--radius-md);">
                ...
                <a href="<?php echo e(route('appointments.index')); ?>" class="btn btn-ghost btn-sm" style="font-weight: 600;">
                    Book Clinician →
                </a>
            </div>
...
<div id="addPetModal" style="display: none; position: fixed; inset: 0; z-index: 9999; background: rgba(13, 15, 17, 0.65); backdrop-filter: blur(4px); align-items: center; justify-content: center; padding: 20px;">
    <div class="card" style="max-width: 520px; width: 100%; max-height: 90vh; overflow-y: auto; box-shadow: var(--shadow-lg); background: var(--white); border-radius: var(--radius-lg);">
        ...
        <form action="<?php echo e(route('pets.store')); ?>" method="POST" style="padding: 24px;">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pat\FurShield\resources\views/frontend/pets/index.blade.php ENDPATH**/ ?>