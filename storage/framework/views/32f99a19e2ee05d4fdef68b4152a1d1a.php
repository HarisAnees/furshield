<?php $__env->startSection('title', 'Your Cart — FurShield'); ?>
...
<div class="container section">
    ...
    <div class="section-head-split reveal">
        <div>
            ...
            <p><?php echo e(count($cart) > 0 ? count($cart) . ' item(s) selected' : 'Review your selected pet care products'); ?></p>
        </div>
    ...
    <div style="display: grid; grid-template-columns: 1fr 380px; gap: 36px; align-items: start;" class="reveal delay-1">
        ...
        <div class="card" style="overflow: hidden;">
            <?php $__currentLoopData = $displayCart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div style="display: flex; justify-content: space-between; align-items: center; padding: 22px 28px; border-bottom: 1px solid var(--border); gap: 20px; flex-wrap: wrap;">
                    ...
                    <div style="display: flex; align-items: center; gap: 16px; min-width: 240px;">
                        <div style="width: 64px; height: 64px; border-radius: var(--radius-sm); border: 1px solid var(--border); background: var(--paper-subtle); display: flex; align-items: center; justify-content: center; padding: 6px; flex-shrink: 0;">
                            <img src="<?php echo e($item['image'] ?? '/images/dog-food.jpg'); ?>" alt="<?php echo e($item['name']); ?>" style="max-height: 100%; max-width: 100%; object-fit: contain;">
                        </div>
                        <div>
        ...
        <div class="card card-padded" style="background: var(--white); position: sticky; top: 100px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 20px; font-size: 0.95rem;">
                <div style="display: flex; justify-content: space-between; color: var(--muted);">
                    <span>Subtotal</span>
                    <strong style="color: var(--ink); font-family: var(--font-mono);">$<?php echo e(number_format($calcSubtotal, 2)); ?></strong>
                </div>
                <div style="display: flex; justify-content: space-between; color: var(--muted);">
            ...
            <div style="border-top: 1px solid var(--border); padding-top: 16px; margin-bottom: 24px; display: flex; justify-content: space-between; align-items: baseline;">
                ...
                <span style="font-size: 1.5rem; font-weight: 800; font-family: var(--font-mono); color: var(--ink);">
                    $<?php echo e(number_format($calcSubtotal, 2)); ?>

                </span>
            </div>

            <a href="<?php echo e(route('checkout.index')); ?>" class="btn btn-primary btn-block">
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pat\FurShield\resources\views/frontend/cart.blade.php ENDPATH**/ ?>