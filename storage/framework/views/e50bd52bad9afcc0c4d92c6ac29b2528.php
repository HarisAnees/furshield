...
<head>
    ...
    <title>FurShield — <?php echo $__env->yieldContent('title', 'Animal Shelter Operations Portal'); ?></title>
        ...
        <aside class="owner-sidebar" id="sidebar">
            <div>
                <div class="sidebar-top">
                    <a class="brand-lockup" href="<?php echo e(route('shelter.dashboard')); ?>">
                ...
                <nav class="owner-nav-list" aria-label="Shelter navigation">
                    <a class="owner-nav-item <?php echo e(request()->routeIs('shelter.dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('shelter.dashboard')); ?>">
                        <span class="nav-icon">
                    ...
                    <a class="owner-nav-item <?php echo e(request()->routeIs('shelter.listings*') ? 'active' : ''); ?>" href="<?php echo e(route('shelter.listings')); ?>">
                        <span class="nav-icon">
                    ...
                    <a class="owner-nav-item <?php echo e(request()->routeIs('shelter.care-logs*') ? 'active' : ''); ?>" href="<?php echo e(route('shelter.care-logs')); ?>">
                        <span class="nav-icon">
                            <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line></svg>
                        </span>
                        <span>Daily Care Logs</span>
                    </a>
                    <a class="owner-nav-item <?php echo e(request()->routeIs('shelter.applications*') ? 'active' : ''); ?>" href="<?php echo e(route('shelter.applications')); ?>">
                        <span class="nav-icon">
            ...
            <header class="owner-topbar">
                <div style="display: flex; align-items: center; gap: 12px;">
                    ...
                    <span style="font-size: 13px; color: #64748b; font-weight: 500;">
                        <?php echo e($shelter->organization_name ?? Auth::user()->name); ?>
...
<?php /**PATH D:\pat\FurShield\resources\views/shelter/layouts/app.blade.php ENDPATH**/ ?>