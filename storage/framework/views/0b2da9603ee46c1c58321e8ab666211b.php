<?php $__env->startSection('title', 'About FurShield — A Better Way to Care for Pets'); ?>
...
<div class="container section">
    ...
    <div id="mission" class="about-movie-card reveal delay-2">
        <div class="movie-container">
            <a href="<?php echo e(route('adoption.index')); ?>">
                ...
                <div class="movie-column2">
                    ...
                    <div class="movie-avatars-wrap">
                        <div class="movie-avatars">
                            <a href="<?php echo e(route('appointments.index')); ?>" data-tooltip="Dr. Sarah Jenkins (Senior Clinician)">
                                <img src="/images/vet-sarah.jpg" alt="Dr. Sarah Jenkins">
                            </a>
                            <a href="<?php echo e(route('appointments.index')); ?>" data-tooltip="Dr. Michael Chang (Surgery Specialist)">
                                <img src="/images/vet-michael.jpg" alt="Dr. Michael Chang">
                            </a>
                            <a href="<?php echo e(route('appointments.index')); ?>" data-tooltip="Dr. Emily Rodriguez (Behavioral Medicine)">
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pat\FurShield\resources\views/frontend/about.blade.php ENDPATH**/ ?>