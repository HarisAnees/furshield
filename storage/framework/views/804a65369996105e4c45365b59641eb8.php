<?php $__env->startSection('title', 'Healthy Pets, Happier Lives — FurShield'); ?>

<?php $__env->startSection('cinematic_loader'); ?>
            ...
            <div class="fe-mugsy-inner-card">
                ...
                <div class="fe-mugsy-bottom-bar">
                    ...
                    <div class="fe-mugsy-tab-left">
                        <a href="<?php echo e(route('appointments.index')); ?>" class="fe-mugsy-btn">
                    ...
                    <div class="fe-mugsy-tab-right">
                        <a href="<?php echo e(route('pets.index')); ?>" class="fe-mugsy-circle-btn" title="View Pet Profiles" aria-label="View Pet Profiles">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
                                <line x1="19" y1="12" x2="5" y2="12"></line>
                                <polyline points="12 19 5 12 12 5"></polyline>
                            </svg>
                        </a>
                        <a href="<?php echo e(route('products.index')); ?>" class="fe-mugsy-circle-btn" title="Shop Pet Essentials" aria-label="Shop Pet Essentials">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
                                <line x1="5" y1="12" x2="19" y2="12"></line>
                                <polyline points="12 5 19 12 12 19"></polyline>
                            </svg>
...
<section class="section">
    <div class="container">
        ...
        <div class="fe-services-grid reveal delay-1">
            <!-- 01: Veterinary Care -->
            <a href="<?php echo e(route('appointments.index')); ?>" class="fe-service-item">
            ...
            <!-- 02: Pet Profiles -->
            <a href="<?php echo e(route('pets.index')); ?>" class="fe-service-item">
            ...
            <!-- 03: Adoption -->
            <a href="<?php echo e(route('adoption.index')); ?>" class="fe-service-item">
            ...
            <!-- 04: Products -->
            <a href="<?php echo e(route('products.index')); ?>" class="fe-service-item">
...
<section class="section" style="background: var(--white); border-top: 1px solid var(--border); border-bottom: 1px solid var(--border);">
    <div class="container">
        <div class="section-head-split reveal">
            ...
            <a href="<?php echo e(route('adoption.index')); ?>" class="btn btn-secondary btn-sm">
        ...
        <div class="fe-adopt-grid reveal delay-1">
            <?php $__empty_1 = true; $__currentLoopData = $adoptablePets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                ...
                <div class="card fe-notch-card">
                    <div class="card-inner" style="--clr: #ffffff;">
                        <div class="box">
                            <div class="imgBox">
                                <img src="<?php echo e($img); ?>" alt="<?php echo e($pet->pet_name); ?>">
                            </div>
                            <div class="icon">
                                <a href="<?php echo e(route('adoption.index')); ?>" class="iconBox" aria-label="Meet <?php echo e($pet->pet_name); ?>" title="Meet <?php echo e($pet->pet_name); ?>">
                    ...
                    <div class="content">
                        <h3><?php echo e($pet->pet_name); ?></h3>
                        <p><?php echo e($pet->health_summary ?? $pet->care_summary ?? 'Gentle companion ready for a loving home with complete clinical verification.'); ?></p>
                        <ul>
                            <li style="--clr-tag: #ecfdf5;" class="tag-species"><?php echo e(ucfirst($pet->species ?? 'Companion')); ?></li>
                            <?php if(!empty($pet->breed)): ?>
                                <li style="--clr-tag: #d1fae5;" class="tag-breed"><?php echo e($pet->breed); ?></li>
                            <?php endif; ?>
                            <li style="--clr-tag: #f4f4f5;" class="tag-age"><?php echo e($pet->age_text ?? '2 Years'); ?></li>
                            <?php if(!empty($pet->sex)): ?>
                                <li style="--clr-tag: #ecfdf5;" class="tag-sex"><?php echo e(ucfirst($pet->sex)); ?></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </div>
            ...
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="glow-card" data-glow-color="rgba(16, 185, 129, 0.45)">
                    ...
                    <div class="card-content">
                        <div class="card-img">
                            <img src="<?php echo e($img); ?>" alt="<?php echo e($prod->name); ?>" loading="lazy">
                            <div class="card-badge"><?php echo e($badge); ?></div>
                        </div>
                        <div class="card-body">
                            <div class="card-tag"><?php echo e(ucfirst($prod->category ?? 'Care Essential')); ?></div>
                            <h3 class="card-title"><?php echo e($prod->name); ?></h3>
                            <div class="card-rating">
                                <span class="stars">★★★★★</span>
                                <span class="rating-count"><?php echo e($rating); ?> (<?php echo e($reviews); ?>)</span>
                            </div>
                            <p class="card-price">
                                <span class="price-original">$<?php echo e(number_format($originalPrice, 2)); ?></span>
                                $<?php echo e(number_format($prod->price, 2)); ?>

                            </p>
                            <form action="<?php echo e(route('cart.add', $prod)); ?>" method="POST" class="card-actions">
                                <?php echo csrf_field(); ?>
...
<section class="section-sm" style="background: var(--white); border-top: 1px solid var(--border); border-bottom: 1px solid var(--border);">
    <div class="container">
        <div class="card card-padded" style="background: var(--paper); border: 1px solid var(--border); display: flex; justify-content: space-between; align-items: center; gap: 32px; flex-wrap: wrap;">
            ...
            <div>
                <a href="<?php echo e(route('care-tips.index')); ?>" class="btn btn-primary">
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pat\FurShield\resources\views/frontend/home.blade.php ENDPATH**/ ?>