...
<head>
    ...
    <title>FurShield Admin — <?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?></title>
...
<div class="admin-shell">
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-top">
            <a class="brand-lockup" href="<?php echo e(route('admin.dashboard')); ?>">
        ...
        <nav class="nav-list" aria-label="Admin Navigation">
            ...
            <a class="nav-item <?php echo e(request()->routeIs('admin.pets.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.pets.index')); ?>">
                <span class="nav-icon">
            ...
            <a class="nav-item <?php echo e(request()->routeIs('admin.appointments.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.appointments.index')); ?>">
                <span class="nav-icon">
            ...
            <a class="nav-item <?php echo e(request()->routeIs('admin.health-records.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.health-records.index')); ?>">
                <span class="nav-icon">
                    <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line></svg>
                </span>
                <span>Health Records</span>
            </a>
            <a class="nav-item <?php echo e(request()->routeIs('admin.adoptions.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.adoptions.index')); ?>">
                <span class="nav-icon">
            ...
            <a class="nav-item <?php echo e(request()->routeIs('admin.products.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.products.index')); ?>">
                <span class="nav-icon">
            ...
            <a class="nav-item <?php echo e(request()->routeIs('admin.orders.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.orders.index')); ?>">
                <span class="nav-icon">
            ...
            <a class="nav-item <?php echo e(request()->routeIs('admin.content.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.content.index')); ?>">
                <span class="nav-icon">
            ...
            <a class="nav-item <?php echo e(request()->routeIs('admin.notifications.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.notifications.index')); ?>">
                <span class="nav-icon">
            ...
            <a class="nav-item <?php echo e(request()->routeIs('admin.settings.*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.settings.index')); ?>">
                <span class="nav-icon">
        ...
        <div class="sidebar-bottom">
            <a href="<?php echo e(route('owner.dashboard')); ?>" class="switch-view-link">
                <span>🐾</span>
                <div>
    ...
    <div class="main-area">
        ...
        <div class="top-nav-switcher">
            <div class="switcher-pill">
                ...
                <a href="<?php echo e(route('home')); ?>" class="switcher-btn">
                    ● Website
                </a>
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="switcher-btn active">
                    <span class="dot-status"></span> Admin Dashboard
                </a>
                <a href="<?php echo e(route('owner.dashboard')); ?>" class="switcher-btn">
                    Pet Owner Portal
                </a>
            </div>
        </div>
        ...
        <header class="topbar">
            ...
            <div class="page-title-block">
                <h1><?php echo $__env->yieldContent('page_title', 'Admin Dashboard'); ?></h1>
                <p><?php echo $__env->yieldContent('page_subtitle', "System status and management metrics across FurShield."); ?></p>
            </div>
            ...
            <div class="topbar-right">
                ...
                <div class="admin-profile">
                    ...
                    <div class="admin-info">
                        <strong><?php echo e(auth()->user()?->name ?? 'Administrator'); ?></strong>
        ...
        <main class="content">
            ...
            <?php if($errors->any()): ?>
            <div class="flash-alert error">
                <div>⚠️ <?php echo e($errors->first()); ?></div>
                <button type="button" class="flash-close-btn" onclick="this.parentElement.remove()" aria-label="Close alert">&times;</button>
            </div>
            <?php endif; ?>
...
<?php /**PATH D:\pat\FurShield\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>