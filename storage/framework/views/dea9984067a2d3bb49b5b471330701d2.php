<?php $__env->startSection('title', 'Pet Care & Clinical Advice — FurShield'); ?>
...
<div class="container section">
    ...
    <div class="reveal delay-1" style="display: flex; justify-content: center; gap: 8px; margin-bottom: 48px; flex-wrap: wrap;">
        ...
        <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <a href="<?php echo e($url); ?>" 
               class="btn btn-sm <?php echo e($isActive ? 'btn-primary' : 'btn-secondary'); ?>">
                <?php echo e($cat); ?>
    ...
    <div class="care-poster-stack reveal delay-2">
        ...
        <?php $__currentLoopData = $panelArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $art): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="care-poster-card-wrapper">
                <div class="care-poster-card-contents"
                     role="button"
                     tabindex="0"
                     onclick="openArticleModal('<?php echo e(addslashes($art['title'])); ?>', '<?php echo e(addslashes($art['cat'])); ?>', '<?php echo e($art['time']); ?>')">
                    
                    <div class="care-poster-badge">
                        <span class="care-badge-dot"></span>
                        <span><?php echo e(strtoupper($art['cat'])); ?></span>
                    </div>

                    <img src="<?php echo e($art['img']); ?>" alt="<?php echo e($art['title']); ?>" class="care-poster-img">

                    <div class="care-poster-description">
                        <h3 class="care-description__title">
                            <?php echo e($art['title']); ?>

                            <span class="care-description__year">(<?php echo e($art['time']); ?>)</span>
                        </h3>

                        <div class="care-description__genres">
                            <?php $__currentLoopData = $art['genres']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $genre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="care-description__genre"><?php echo e($genre); ?></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\pat\FurShield\resources\views/frontend/care_tips.blade.php ENDPATH**/ ?>