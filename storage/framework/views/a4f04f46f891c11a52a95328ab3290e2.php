...
<header class="fe-navbar">
    <div class="fe-container fe-navbar-inner" style="display: flex; align-items: center; justify-content: space-between; padding: 18px 24px;">
        <a href="<?php echo e(route('home')); ?>" class="fe-brand" style="display: flex; align-items: center; gap: 10px; text-decoration: none;">
        ...
        <div style="display: flex; align-items: center; gap: 1rem;">
            <a href="<?php echo e(route('home')); ?>" style="color: #6b7280; font-family: var(--font-mono, monospace); font-size: 0.82rem; text-decoration: none; font-weight: 500;">
                ← Back to Website
            </a>
        </div>
    </div>
            ...
            <form action="<?php echo e(route('login.submit')); ?>" method="POST">
                ...
                <div style="margin-bottom: 1.25rem;">
                    ...
                    <input type="email" name="email" id="inputEmail" required 
                           value="<?php echo e(old('email', 'admin@furshield.test')); ?>" 
...
<?php /**PATH D:\pat\FurShield\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>