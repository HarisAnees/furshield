...
<head>
    ...
    <title>FurShield — @yield('title', 'Veterinary Clinician Portal')</title>
        ...
        <aside class="owner-sidebar" id="sidebar">
            <div class="owner-sidebar-content-scroll">
                ...
                <nav class="owner-nav-list" aria-label="Veterinarian navigation">
                    <a class="owner-nav-item {{ request()->routeIs('vet.dashboard') ? 'active' : '' }}" href="{{ route('vet.dashboard') }}">
                        <span class="nav-icon">
                    ...
                    <a class="owner-nav-item {{ request()->routeIs('vet.appointments*') ? 'active' : '' }}" href="{{ route('vet.appointments') }}">
                        <span class="nav-icon">
                    ...
                    <a class="owner-nav-item {{ request()->routeIs('vet.profile*') ? 'active' : '' }}" href="{{ route('vet.profile') }}">
                        <span class="nav-icon">
