...
<div style="padding: 1.5rem 0;">
    ...
    <div class="owner-subpage-card" style="padding: 0; overflow: hidden;">
        @php
            $panelRows = [
                ['type' => 'Vaccination', 'title' => 'Rabies Vaccine', 'date' => 'Apr 15, 2025', 'icon' => 'fa-solid fa-syringe', 'color' => '#0284c7', 'bg' => '#e0f2fe'],
                ['type' => 'General Checkup', 'title' => 'Routine Health Check', 'date' => 'Mar 10, 2025', 'icon' => 'fa-solid fa-stethoscope', 'color' => '#059669', 'bg' => '#ecfdf5'],
                ['type' => 'Treatment', 'title' => 'Ear Infection', 'date' => 'Feb 20, 2025', 'icon' => 'fa-solid fa-pills', 'color' => '#2563eb', 'bg' => '#dbeafe'],
                ['type' => 'Vaccination', 'title' => 'DHPP Vaccine', 'date' => 'Jan 12, 2025', 'icon' => 'fa-solid fa-shield-virus', 'color' => '#0284c7', 'bg' => '#e0f2fe'],
            ];
        @endphp
        ...
        @foreach($panelRows as $row)
            <div class="owner-activity-row">
                <div style="display: flex; align-items: center; gap: 1rem;">
                    <!-- Circular Icon -->
                    <div style="width: 44px; height: 44px; border-radius: 50%; background: {{ $row['bg'] }}; color: {{ $row['color'] }}; font-size: 1.1rem; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                        <i class="{{ $row['icon'] }}"></i>
                    </div>
