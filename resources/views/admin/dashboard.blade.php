...
<div class="admin-dashboard-container">
    ...
    <div class="dashboard-hero-strip">
        ...
        <div class="hero-quick-actions">
            <a href="{{ route('admin.users.index') }}" class="quick-action-pill primary">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                <span>Add User</span>
            </a>
            <a href="{{ route('admin.appointments.index') }}" class="quick-action-pill">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                <span>Consultations</span>
            </a>
            <a href="{{ route('admin.pets.index') }}" class="quick-action-pill">
            ...
            <a href="{{ route('admin.notifications.index') }}" class="quick-action-pill">
    ...
    <div class="kpi-grid">
        <!-- Card 1: Total Users -->
        <a href="{{ route('admin.users.index') }}" class="kpi-card" title="Click to manage users">
            ...
            <div class="kpi-details">
                ...
                <div class="kpi-body-row">
                    <strong class="kpi-value">{{ number_format($stats['users']) }}</strong>
        ...
        <!-- Card 2: Total Pets -->
        <a href="{{ route('admin.pets.index') }}" class="kpi-card" title="Click to view pet registry">
            <div class="kpi-card-top">
            ...
            <div class="kpi-details">
                ...
                <div class="kpi-body-row">
                    <strong class="kpi-value">{{ number_format($stats['pets']) }}</strong>
                    <div class="kpi-trend up">
                        <span>↑ 8%</span>
                    </div>
                </div>
        ...
        <a href="{{ route('admin.appointments.index') }}" class="kpi-card" title="Click to view today's schedule">
            <div class="kpi-card-top">
            ...
            <div class="kpi-details">
                ...
                <div class="kpi-body-row">
                    <strong class="kpi-value">{{ number_format($stats['appointments_today']) }}</strong>
                    <div class="kpi-trend up">
                        <span>↑ 15%</span>
                    </div>
                </div>
        ...
        <!-- Card 4: Total Orders -->
        <a href="{{ route('admin.orders.index') }}" class="kpi-card" title="Click to view marketplace orders">
            <div class="kpi-card-top">
            ...
            <div class="kpi-details">
                ...
                <div class="kpi-body-row">
                    <strong class="kpi-value">{{ number_format($stats['orders']) }}</strong>
                    <div class="kpi-trend up">
                        <span>↑ 9%</span>
                    </div>
                </div>
    ...
    <div class="panels-grid middle-grid">
        ...
        <div class="dashboard-panel distribution-panel">
            <div class="panel-header">
                ...
                <a href="{{ route('admin.users.index') }}" class="view-all-link">Roles →</a>
            </div>
            <div class="distribution-content">
                <div class="donut-chart-box">
                    ...
                    <div class="donut-center-info">
                        <strong>{{ number_format($roleTotal) }}</strong>
        ...
        <div class="dashboard-panel appointments-panel">
            <div class="panel-header">
                ...
                <a href="{{ route('admin.appointments.index') }}" class="view-all-link">Full schedule →</a>
            </div>
            <div class="table-responsive">
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="font-medium" style="font-weight: 700; color: var(--ink);">{{ $appt->pet?->name ?? 'Buddy' }}</td>
                            <td style="color: #475569;">{{ $appt->user?->name ?? 'Sarah J.' }}</td>
                            <td style="color: #475569;">{{ $appt->vet?->user?->name ? str_replace('Dr. Emily Carter', 'Dr. Carter', $appt->vet->user->name) : 'Dr. Carter' }}</td>
                            <td style="font-family: var(--font-mono); font-size: 11px; color: var(--muted);">{{ $appt->starts_at ? $appt->starts_at->format('M d, h:i A') : 'Apr 25, 10:00 AM' }}</td>
                            <td>
                                @if(strtolower($appt->status) === 'pending')
    ...
    <div class="panels-grid bottom-grid">
                        ...
                        <tr>
                            <td>
                                <div class="user-cell">
                                    ...
                                    @endphp
                                    <img src="{{ $userAvatar }}" alt="{{ $user->name }}" class="user-avatar-mini" onerror="this.src='https://ui-avatars.com/api/?name={{ urlencode($user->name) }}&background=f1f5f9&color=0f172a'">
                                    <span style="font-weight: 600; color: var(--ink);">{{ $user->name }}</span>
                                </div>
                            </td>
                            <td class="text-muted" style="font-family: var(--font-mono); font-size: 11px;">{{ $user->email }}</td>
                            <td>
                                @if($user->role === 'admin')
                            ...
                            <td class="text-muted" style="font-family: var(--font-mono); font-size: 11px;">{{ $user->created_at ? $user->created_at->format('M d, Y') : 'Apr 24, 2025' }}</td>
                        </tr>
                        @empty
                        <tr>
                            <td>
        ...
        <div class="dashboard-panel products-panel">
            <div class="panel-header">
                ...
                <a href="{{ route('admin.products.index') }}" class="view-all-link">Store catalog →</a>
            </div>
            <div class="products-list">
                ...
                @endphp
                @foreach($staticProducts as $prod)
                <div class="product-item">
                    <img src="{{ $prod['img'] }}" alt="{{ $prod['name'] }}" class="product-thumb-img">
        ...
        <div class="dashboard-panel activities-panel">
            <div class="panel-header">
                ...
                <a href="{{ route('admin.notifications.index') }}" class="view-all-link">Activity log →</a>
            </div>
